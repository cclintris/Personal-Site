  ...
  const handleClicked = () => {
    ...
    if (click % 2 === 0) {
      setX(
        Array(6)
          .fill()
          .map(() => Math.round(_W / 2 - 30))
      );
      setY(
        Array(6)
          .fill()
          .map(() => Math.round(_H / 2 + 30))
      );
    } else {
      setX(
        Array(6)
          .fill()
          .map(() => Math.round(Math.random() * _W))
      );
      setY(
        Array(6)
          .fill()
          .map(() => Math.round(Math.random() * _H))
      );
    }
  };
